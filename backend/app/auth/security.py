...
async def get_current_principal(
    ...
    return Principal(actor=x_user_email or "anonymous", role=x_user_role or "user")


def require_role(*allowed_roles: str):
    async def dependency(principal: Principal = None):
        principal = principal or Principal(actor="anonymous", role="user")
